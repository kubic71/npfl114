...
class Network:
    def __init__(self, args):
        ...
        input1 = keras.layers.Input(shape=(MNIST.H, MNIST.W, MNIST.C))
        input2 = keras.layers.Input(shape=(MNIST.H, MNIST.W, MNIST.C))

        hidden1 = keras.layers.Conv2D(10, 3, 2, "valid")(input1)
