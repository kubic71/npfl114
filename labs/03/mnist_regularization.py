...
# labels_train = np.array([[0] * mnist.LABELS for label in mnist.train.data["labels"]])
# labels_dev = np.array([[0] * mnist.LABELS for label in mnist.dev.data["labels"]])
#
# for i in range(len(labels_train)):
#     labels_train[i][mnist.train.data["labels"][i]] = 1
#
#
# for i in range(len(labels_dev)):
#     labels_dev[i][mnist.dev.data["labels"][i]] = 1
mnist.dev.data["labels"] = to_categorical(mnist.dev.data["labels"])
mnist.train.data["labels"] = to_categorical(mnist.train.data["labels"])
mnist.test.data["labels"] = to_categorical(mnist.test.data["labels"])
